...
namespace BotFrameworkDsl
{
	...
	/// </summary>
	public static partial class NodeReferencesTargetsBuilder
	{
		...
		public static bool CanAcceptSource(DslModeling::ModelElement candidate)
		{
			...
			else if (candidate is global::BotFrameworkDsl.Node)
			{ 
				return true;
			}
			else
			...
			else // Check combinations
			{
				if (candidateSource is global::BotFrameworkDsl.Node)
				{
					if (candidateTarget is global::BotFrameworkDsl.Node)
					{
						...
						if(targetNode == null || sourceNode == null || global::BotFrameworkDsl.NodeReferencesTargets.GetLinks(sourceNode, targetNode).Count > 0) return false;
						return true;
					}
				}
	...
	/// </summary>
	internal partial class ConversationFlowConnectAction : DslDiagrams::ConnectAction
	{
		private DslDiagrams::ConnectionType[] connectionTypes;
		
		/// <summary>
		/// Constructs a new ConversationFlowConnectAction for the given Diagram.
		/// </summary>
		public ConversationFlowConnectAction(DslDiagrams::Diagram diagram): base(diagram, true) 
		{
		}
		...
		/// <summary>
		/// Returns the ConversationFlowConnectionType associated with this action.
		/// </summary>
		protected override DslDiagrams::ConnectionType[] GetConnectionTypes(DslDiagrams::ShapeElement sourceShapeElement, DslDiagrams::ShapeElement targetShapeElement)
		{
			...
			{
				this.connectionTypes = new DslDiagrams::ConnectionType[] { new ConversationFlowConnectionType() };
			}
			
			return this.connectionTypes;
		}
		
		private partial class ConversationFlowConnectionTypeBase : DslDiagrams::ConnectionType
		{
			/// <summary>
			/// Constructs a new the ConversationFlowConnectionType with the given ConnectionBuilder.
			/// </summary>
			protected ConversationFlowConnectionTypeBase() : base() {}
			...
			/// </summary>
			/// <remarks>
			/// This implementation delegates calls to the ConnectionBuilder NodeReferencesTargetsBuilder.
			/// </remarks>
			public override bool CanCreateConnection(DslDiagrams::ShapeElement sourceShapeElement, DslDiagrams::ShapeElement targetShapeElement, ref string connectionWarning)
			{
				...
				{				
					if(targetShapeElement == null)
					{
						return NodeReferencesTargetsBuilder.CanAcceptSource(sourceElement);
					}
					else
					{				
						return NodeReferencesTargetsBuilder.CanAcceptSourceAndTarget(sourceElement, targetElement);
					}
				}
				else
				{
			...
			public override void CreateConnection(DslDiagrams::ShapeElement sourceShapeElement, DslDiagrams::ShapeElement targetShapeElement, DslDiagrams::PaintFeedbackArgs paintFeedbackArgs)
			{
				...
				if(targetElement == null) targetElement = targetShapeElement;
				NodeReferencesTargetsBuilder.Connect(sourceElement, targetElement);
			}
		}
		
		private partial class ConversationFlowConnectionType : ConversationFlowConnectionTypeBase
		{
			/// <summary>
			/// Constructs a new the ConversationFlowConnectionType with the given ConnectionBuilder.
			/// </summary>
			public ConversationFlowConnectionType() : base() {}
		}
	}
}
