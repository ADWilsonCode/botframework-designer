...
namespace BotFrameworkDsl
{
	...
	/// </remarks>
	public partial class BotFrameworkDslToolboxHelper : BotFrameworkDslToolboxHelperBase 
	{
		/// <summary>
		/// Constructs a new BotFrameworkDslToolboxHelper.
		/// </summary>
		public BotFrameworkDslToolboxHelper(global::System.IServiceProvider serviceProvider)
	...
	public abstract class BotFrameworkDslToolboxHelperBase
	{
		/// <summary>
		/// Toolbox item filter string used to identify BotFrameworkDsl toolbox items.  
		/// </summary>
		/// <remarks>
		/// See the MSDN documentation for the ToolboxItemFilterAttribute class for more information on toolbox
		/// item filters.
		/// </remarks>
		public const string ToolboxFilterString = "BotFrameworkDsl.1.0";
		/// <summary>
		/// Toolbox item filter string used to identify ConversationFlow connector tool.
		/// </summary>
		public const string ConversationFlowFilterString = "ConversationFlow.1.0";
		...
		/// <summary>
		/// Constructs a new BotFrameworkDslToolboxHelperBase.
		/// </summary>
		protected BotFrameworkDslToolboxHelperBase(global::System.IServiceProvider serviceProvider)
		{
		...
		public static string DefaultToolboxTabName
		{
			get
			{
				return global::BotFrameworkDsl.BotFrameworkDslDomainModel.SingletonResourceManager.GetString("BotFrameworkDslToolboxTab", global::System.Globalization.CultureInfo.CurrentUICulture);
			}
		}
		...
		protected DslModeling::Store ToolboxStore
		{
			...
			{ 
				if (toolboxStore==null)
				{
					...
					toolboxStore.LoadDomainModels(typeof(global::BotFrameworkDsl.BotFrameworkDslDomainModel));
