...
namespace BotFrameworkDsl
{
	...
	/// </remarks>
	public partial class BotFrameworkDslHelpKeywordHelper : BotFrameworkDslHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new BotFrameworkDslHelpKeywordHelper.
		/// </summary>
		protected BotFrameworkDslHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the BotFrameworkDslHelpKeywordHelper.
		/// </summary>
		public static BotFrameworkDslHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class BotFrameworkDslHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new BotFrameworkDslHelpKeywordHelperBase.
		/// </summary>
		protected BotFrameworkDslHelpKeywordHelperBase()
			: base() { }
