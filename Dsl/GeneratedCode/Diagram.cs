...
[module: global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Maintainability", "CA1506:AvoidExcessiveClassCoupling", Scope = "type", Target = "BotFrameworkDsl.BotFrameworkDslDiagram")]

namespace BotFrameworkDsl
{
	/// <summary>
	/// DomainClass BotFrameworkDslDiagram
	/// Description for BotFrameworkDsl.BotFrameworkDslDiagram
	/// </summary>
	[DslDesign::DisplayNameResource("BotFrameworkDsl.BotFrameworkDslDiagram.DisplayName", typeof(global::BotFrameworkDsl.BotFrameworkDslDomainModel), "BotFrameworkDsl.GeneratedCode.DomainModelResx")]
	[DslDesign::DescriptionResource("BotFrameworkDsl.BotFrameworkDslDiagram.Description", typeof(global::BotFrameworkDsl.BotFrameworkDslDomainModel), "BotFrameworkDsl.GeneratedCode.DomainModelResx")]
	[DslModeling::DomainModelOwner(typeof(global::BotFrameworkDsl.BotFrameworkDslDomainModel))]
	[global::System.CLSCompliant(true)]
	[DslModeling::DomainObjectId("8d40aa7b-f71d-4256-aa63-2f51c17b6350")]
	public partial class BotFrameworkDslDiagram : DslDiagrams::Diagram
	{
		...
		private static global::System.ComponentModel.ToolboxItemFilterAttribute[] toolboxFilters = new global::System.ComponentModel.ToolboxItemFilterAttribute[] {
					new global::System.ComponentModel.ToolboxItemFilterAttribute(global::BotFrameworkDsl.BotFrameworkDslToolboxHelperBase.ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) };
		...
		{
			if(element is global::BotFrameworkDsl.Start)
			{
				global::BotFrameworkDsl.StartShape newShape = new global::BotFrameworkDsl.StartShape(this.Partition);
				if(newShape != null) newShape.Size = newShape.DefaultSize; // set default shape size
				return newShape;
			}
			if(element is global::BotFrameworkDsl.Speak)
			{
				global::BotFrameworkDsl.SpeakShape newShape = new global::BotFrameworkDsl.SpeakShape(this.Partition);
				if(newShape != null) newShape.Size = newShape.DefaultSize; // set default shape size
				return newShape;
			}
			if(element is global::BotFrameworkDsl.End)
			{
				global::BotFrameworkDsl.EndShape newShape = new global::BotFrameworkDsl.EndShape(this.Partition);
				if(newShape != null) newShape.Size = newShape.DefaultSize; // set default shape size
				return newShape;
			}
			if(element is global::BotFrameworkDsl.Listen)
			{
				global::BotFrameworkDsl.ListenShape newShape = new global::BotFrameworkDsl.ListenShape(this.Partition);
				if(newShape != null) newShape.Size = newShape.DefaultSize; // set default shape size
				return newShape;
			}
			if(element is global::BotFrameworkDsl.NodeReferencesTargets)
			{
				global::BotFrameworkDsl.ConversationFlow newShape = new global::BotFrameworkDsl.ConversationFlow(this.Partition);
				return newShape;
			}
		...
		protected override void InitializeShapeFields(global::System.Collections.Generic.IList<DslDiagrams::ShapeField> shapeFields)
		{
			...
			global::BotFrameworkDsl.StartShape.DecoratorsInitialized += StartShapeDecoratorMap.OnDecoratorsInitialized;
			global::BotFrameworkDsl.ListenShape.DecoratorsInitialized += ListenShapeDecoratorMap.OnDecoratorsInitialized;
			global::BotFrameworkDsl.SpeakShape.DecoratorsInitialized += SpeakShapeDecoratorMap.OnDecoratorsInitialized;
			global::BotFrameworkDsl.EndShape.DecoratorsInitialized += EndShapeDecoratorMap.OnDecoratorsInitialized;
		}
		
		/// <summary>
		/// Class containing decorator path traversal methods for StartShape.
		/// </summary>
		internal static partial class StartShapeDecoratorMap
		{
			/// <summary>
			/// Event handler called when decorator initialization is complete for StartShape.  Adds decorator mappings for this shape or connector.
			/// </summary>
			public static void OnDecoratorsInitialized(object sender, global::System.EventArgs e)
			{
				...
				propertyInfo = new DslDiagrams::AssociatedPropertyInfo(global::BotFrameworkDsl.Start.NameDomainPropertyId);
		...
		/// <summary>
		/// Class containing decorator path traversal methods for ListenShape.
		/// </summary>
		internal static partial class ListenShapeDecoratorMap
		{
			/// <summary>
			/// Event handler called when decorator initialization is complete for ListenShape.  Adds decorator mappings for this shape or connector.
			/// </summary>
			public static void OnDecoratorsInitialized(object sender, global::System.EventArgs e)
			{
				DslDiagrams::ShapeElement shape = (DslDiagrams::ShapeElement)sender;
				...
				propertyInfo = new DslDiagrams::AssociatedPropertyInfo(global::BotFrameworkDsl.Listen.NameDomainPropertyId);
				DslDiagrams::ShapeElement.FindDecorator(shape.Decorators, "NameDecorator").AssociateValueWith(shape.Store, propertyInfo);
		...
		/// <summary>
		/// Class containing decorator path traversal methods for SpeakShape.
		/// </summary>
		internal static partial class SpeakShapeDecoratorMap
		{
			/// <summary>
			/// Event handler called when decorator initialization is complete for SpeakShape.  Adds decorator mappings for this shape or connector.
			/// </summary>
			public static void OnDecoratorsInitialized(object sender, global::System.EventArgs e)
			{
				DslDiagrams::ShapeElement shape = (DslDiagrams::ShapeElement)sender;
				...
				propertyInfo = new DslDiagrams::AssociatedPropertyInfo(global::BotFrameworkDsl.Speak.NameDomainPropertyId);
				DslDiagrams::ShapeElement.FindDecorator(shape.Decorators, "NameDecorator").AssociateValueWith(shape.Store, propertyInfo);
		...
		/// <summary>
		/// Class containing decorator path traversal methods for EndShape.
		/// </summary>
		internal static partial class EndShapeDecoratorMap
		{
			/// <summary>
		...
		private global::BotFrameworkDsl.ConversationFlowConnectAction conversationFlowConnectAction;
		/// <summary>
		...
		public override void OnViewMouseEnter(DslDiagrams::DiagramPointEventArgs pointArgs)
		{
			...
			if(activeView != null)
			{
				...
				if (SelectedToolboxItemSupportsFilterString(activeView, global::BotFrameworkDsl.BotFrameworkDslToolboxHelper.ConversationFlowFilterString))
				{
					if (this.conversationFlowConnectAction == null)
					{
						this.conversationFlowConnectAction = new global::BotFrameworkDsl.ConversationFlowConnectAction(this);
						this.conversationFlowConnectAction.MouseActionDeactivated += new DslDiagrams::MouseAction.MouseActionDeactivatedEventHandler(OnConnectActionDeactivated);
					}
					action = this.conversationFlowConnectAction;
				} 
				else
				{
					action = null;
		...
		protected override void Dispose(bool disposing)
		{
			try
			{
				if(disposing)
				{
					if(this.conversationFlowConnectAction != null)
					{
						this.conversationFlowConnectAction.Dispose();
						this.conversationFlowConnectAction = null;
					}
				}
			}
			finally
		...
		/// <summary>
		/// BotFrameworkDslDiagram domain class Id.
		/// </summary>
		public static readonly new global::System.Guid DomainClassId = new global::System.Guid(0x8d40aa7b, 0xf71d, 0x4256, 0xaa, 0x63, 0x2f, 0x51, 0xc1, 0x7b, 0x63, 0x50);
		/// <summary>
		/// Constructor
		/// </summary>
		/// <param name="store">Store where new element is to be created.</param>
		/// <param name="propertyAssignments">List of domain property id/value pairs to set once the element is created.</param>
		public BotFrameworkDslDiagram(DslModeling::Store store, params DslModeling::PropertyAssignment[] propertyAssignments)
		...
		/// <param name="propertyAssignments">List of domain property id/value pairs to set once the element is created.</param>
		public BotFrameworkDslDiagram(DslModeling::Partition partition, params DslModeling::PropertyAssignment[] propertyAssignments)
...
namespace BotFrameworkDsl
{
		...
		/// </summary>
		[DslModeling::RuleOn(typeof(global::BotFrameworkDsl.Start), FireTime = DslModeling::TimeToFire.TopLevelCommit, Priority = DslDiagrams::DiagramFixupConstants.AddShapeParentExistRulePriority, InitiallyDisabled=true)]
		[DslModeling::RuleOn(typeof(global::BotFrameworkDsl.Speak), FireTime = DslModeling::TimeToFire.TopLevelCommit, Priority = DslDiagrams::DiagramFixupConstants.AddShapeParentExistRulePriority, InitiallyDisabled=true)]
		[DslModeling::RuleOn(typeof(global::BotFrameworkDsl.End), FireTime = DslModeling::TimeToFire.TopLevelCommit, Priority = DslDiagrams::DiagramFixupConstants.AddShapeParentExistRulePriority, InitiallyDisabled=true)]
		[DslModeling::RuleOn(typeof(global::BotFrameworkDsl.Listen), FireTime = DslModeling::TimeToFire.TopLevelCommit, Priority = DslDiagrams::DiagramFixupConstants.AddShapeParentExistRulePriority, InitiallyDisabled=true)]
		[DslModeling::RuleOn(typeof(global::BotFrameworkDsl.NodeReferencesTargets), FireTime = DslModeling::TimeToFire.TopLevelCommit, Priority = DslDiagrams::DiagramFixupConstants.AddConnectionRulePriority, InitiallyDisabled=true)]
		internal sealed partial class FixUpDiagram : FixUpDiagramBase
		{
			...
			public static global::BotFrameworkDsl.BotFrameworkModel GetParentForStart( global::BotFrameworkDsl.Node root )
			{
				// Segments 0 and 1
			...
			public static global::BotFrameworkDsl.BotFrameworkModel GetParentForSpeak( global::BotFrameworkDsl.Node root )
			{
				// Segments 0 and 1
				global::BotFrameworkDsl.BotFrameworkModel result = root.BotFrameworkModel;
				if ( result == null ) return null;
			...
			public static global::BotFrameworkDsl.BotFrameworkModel GetParentForEnd( global::BotFrameworkDsl.Node root )
			{
				// Segments 0 and 1
				global::BotFrameworkDsl.BotFrameworkModel result = root.BotFrameworkModel;
				if ( result == null ) return null;
		...
		internal sealed class ConnectorRolePlayerChanged : DslModeling::RolePlayerChangeRule
		{
			...
			public override void RolePlayerChanged(DslModeling::RolePlayerChangedEventArgs e)
			{
				...
				foreach (DslDiagrams::PresentationViewsSubject connectorLink in connectorLinks)
				{
					...
					if (linkShape != null)
					{
						global::BotFrameworkDsl.BotFrameworkDslDiagram diagram = linkShape.Diagram as global::BotFrameworkDsl.BotFrameworkDslDiagram;
						if (diagram != null)
						{
