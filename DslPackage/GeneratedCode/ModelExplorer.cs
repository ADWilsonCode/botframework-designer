...
namespace BotFrameworkDsl
{
	...
	/// </summary>
	internal partial class BotFrameworkDslExplorer : BotFrameworkDslExplorerBase
	{
		/// <summary>
		/// Constructs a new BotFrameworkDslExplorer.
		/// </summary>
		public BotFrameworkDslExplorer(global::System.IServiceProvider serviceProvider)
	...
	/// <summary>
	/// Control hosted in the BotFrameworkDslExplorerToolWindow.
	/// </summary>
	internal abstract class BotFrameworkDslExplorerBase : DslShell::ModelExplorerTreeContainer
	{
		/// <summary>
		/// Constructs a new BotFrameworkDslExplorerBase.
		/// </summary>
		protected BotFrameworkDslExplorerBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuCommandId
		{
			get
			{
				return Constants.BotFrameworkDslExplorerMenu;
			}
		}
		...
		{
			get { return global::BotFrameworkDsl.BotFrameworkModel.DomainClassId; }
		}
