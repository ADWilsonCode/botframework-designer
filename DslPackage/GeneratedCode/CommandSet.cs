...
namespace BotFrameworkDsl
{
	...
	/// </summary>
	internal partial class BotFrameworkDslCommandSet : BotFrameworkDslCommandSetBase
	{
		/// <summary>
		/// Constructs a new BotFrameworkDslCommandSet.
		/// </summary>
		public BotFrameworkDslCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class BotFrameworkDslCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new BotFrameworkDslCommandSetBase.
		/// </summary>
		protected BotFrameworkDslCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewBotFrameworkDslExplorerCommand,
				typeof(BotFrameworkDslEditorFactory).GUID);
		...
		{
			BotFrameworkDslExplorerToolWindow explorer = this.BotFrameworkDslExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected BotFrameworkDslDocData CurrentBotFrameworkDslDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as BotFrameworkDslDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected BotFrameworkDslDocView CurrentBotFrameworkDslDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as BotFrameworkDslDocView;
			}
		}
		...
		/// </summary>
		protected BotFrameworkDslExplorerToolWindow BotFrameworkDslExplorerToolWindow
		{
			get
			{
				BotFrameworkDslExplorerToolWindow explorerWindow = null;
				DslShell::ModelingPackage package = this.ServiceProvider.GetService(typeof(VSShell::Package)) as DslShell::ModelingPackage;

				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(BotFrameworkDslExplorerToolWindow), true) as BotFrameworkDslExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				BotFrameworkDslExplorerToolWindow explorerWindow = this.BotFrameworkDslExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class BotFrameworkDslClipboardCommandSet : BotFrameworkDslClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new BotFrameworkDslClipboardCommandSet.
		/// </summary>
		public BotFrameworkDslClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class BotFrameworkDslClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new BotFrameworkDslClipboardCommandSetBase.
		/// </summary>
		protected BotFrameworkDslClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
