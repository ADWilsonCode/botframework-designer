...
namespace BotFrameworkDsl
{
	...
	/// </summary>
	internal partial class BotFrameworkDslDocData : BotFrameworkDslDocDataBase
	{
		/// <summary>
		/// Constructs a new BotFrameworkDslDocData.
		/// </summary>
		public BotFrameworkDslDocData(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) 
	...
	/// <summary>
	/// Class which represents a BotFrameworkDsl document in memory.
	/// </summary>
	internal abstract partial class BotFrameworkDslDocDataBase : DslShell::ModelingDocData
	{
		/// <summary>
		...
		/// <summary>
		/// Constructs a new BotFrameworkDslDocDataBase.
		/// </summary>
		protected BotFrameworkDslDocDataBase(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) : base(serviceProvider, editorFactoryId)
		{
		}
		...
		protected override string FormatList
		{
			get
			{
				return global::BotFrameworkDsl.BotFrameworkDslDomainModel.SingletonResourceManager.GetString("FormatList"); 
			}
		}
		...
		protected virtual bool HandleBindingFailure(global::System.Exception exception)
		{
			...
			string errorMessage = string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
				global::BotFrameworkDsl.BotFrameworkDslDomainModel.SingletonResourceManager.GetString("BindingErrorOccurred"),
				exception.ToString());
		...
		protected override global::System.Collections.Generic.IList<global::System.Type> GetDomainModels()
		{
			...
			allTypes.Add(typeof(global::BotFrameworkDsl.BotFrameworkDslDomainModel));
		...
		protected virtual global::System.Collections.Generic.IEnumerable<global::System.Type> GetExtensionDomainModels()
		{
			...
			global::System.Collections.Generic.IEnumerable<global::System.Type> extensionDomainModels = this.ExtensionLocator.GetExtendingDomainModels(typeof(global::BotFrameworkDsl.BotFrameworkDslDomainModel));
		...
		protected override void Load(string fileName, bool isReload)
		{
			...
			global::BotFrameworkDsl.BotFrameworkModel modelRoot = null;
			...
			global::BotFrameworkDsl.BotFrameworkDslDomainModel.EnableDiagramRules(this.Store);
			string diagramFileName = fileName + this.DiagramExtension;
			
			modelRoot = global::BotFrameworkDsl.BotFrameworkDslSerializationHelper.Instance.LoadModelAndDiagram(serializationResult, this.GetModelPartition(), fileName, this.GetDiagramPartition(), diagramFileName, schemaResolver, null /* no load-time validation */, this.SerializerLocator);
			...
			{	
				...
				throw new global::System.InvalidOperationException(global::BotFrameworkDsl.BotFrameworkDslDomainModel.SingletonResourceManager.GetString("CannotOpenDocument"));
			}
			else
			{
						...
						if (itemId != global::Microsoft.VisualStudio.VSConstants.VSITEMID_NIL)
						{
							...
							if (this.diagramDocumentLockHolder == null)
							{
								throw new global::System.InvalidOperationException(string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
													global::BotFrameworkDsl.BotFrameworkDslDomainModel.SingletonResourceManager.GetString("CannotCloseExistingDiagramDocument"),
													diagramFileName));
							}
						}
					}
		...
		{
			DslModeling::SerializationResult serializationResult = new DslModeling::SerializationResult();
			global::BotFrameworkDsl.BotFrameworkModel modelRoot = (global::BotFrameworkDsl.BotFrameworkModel)this.RootElement;
			...
			{
				global::BotFrameworkDsl.BotFrameworkDslDiagram diagram = diagrams[0] as global::BotFrameworkDsl.BotFrameworkDslDiagram;
				if (diagram != null)
				{
					string diagramFileName = fileName + this.DiagramExtension;
					try
					{
						...
						global::BotFrameworkDsl.BotFrameworkDslSerializationHelper.Instance.SaveModelAndDiagram(serializationResult, modelRoot, fileName, diagram, diagramFileName, this.Encoding, false);
					}
					finally
					{
			...
			{
				global::BotFrameworkDsl.BotFrameworkDslSerializationHelper.Instance.SaveModel(serializationResult, modelRoot, fileName, this.Encoding, false);
			}
			// Report serialization messages.
			this.SuspendErrorListRefresh();
			try
			...
			if (serializationResult.Failed)
			{	// Save failed.
				throw new global::System.InvalidOperationException(global::BotFrameworkDsl.BotFrameworkDslDomainModel.SingletonResourceManager.GetString("CannotSaveDocument"));
			}
		}
		/// <summary>
			...
			if (diagrams.Count > 0)
			{
				...
				if (diagram != null)
				{
					try
					{
						...
						global::BotFrameworkDsl.BotFrameworkDslSerializationHelper.Instance.SaveDiagram(serializationResult, diagram, fileName, this.Encoding, false);
					}
					finally
					{
		...
		protected override string SerializedModel
		{
			get
			{
				global::BotFrameworkDsl.BotFrameworkModel modelRoot = this.RootElement as global::BotFrameworkDsl.BotFrameworkModel;
				string modelFile = string.Empty;
				if (modelRoot != null)
				{
					modelFile = global::BotFrameworkDsl.BotFrameworkDslSerializationHelper.Instance.GetSerializedModelString(modelRoot, this.Encoding);
				}
				return modelFile;
			}
		}
