...
namespace BotFrameworkDsl
{
	...
	/// </summary>
	internal partial class BotFrameworkDslDocView : BotFrameworkDslDocViewBase
	{
		/// <summary>
		/// Constructs a new BotFrameworkDslDocView.
		/// </summary>
		public BotFrameworkDslDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class BotFrameworkDslDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new BotFrameworkDslDocView.
		/// </summary>
		protected BotFrameworkDslDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			BotFrameworkDslDocDataBase docData = this.DocData as BotFrameworkDslDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for BotFrameworkDslDocViewBase should be an BotFrameworkDslDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::BotFrameworkDsl.BotFrameworkDslDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::BotFrameworkDsl.BotFrameworkDslDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::BotFrameworkDsl.BotFrameworkDslToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::BotFrameworkDsl.BotFrameworkDslToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.BotFrameworkDslDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::BotFrameworkDsl.BotFrameworkDslHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::BotFrameworkDsl.BotFrameworkDslHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::BotFrameworkDsl.BotFrameworkDslHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
